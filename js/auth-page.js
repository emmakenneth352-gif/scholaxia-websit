(function () {
  ...
  var ROLE_META = {
    ...
    teacher: {
      ...
      subSignup: "Teachers are added by admin — use Log in",
      allowSignup: false,
    },
    kind: {
  ...
  function updateCopy() {
    ...
    $("btnSignup").disabled = role === "teacher";
    $("tabSignup").disabled = role === "teacher";
    $("gotoSignup").disabled = role === "teacher";
