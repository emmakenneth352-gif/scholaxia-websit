        ...
        child: Column(
          ...
          children: [
            ...
            if (!_otpStep) ...[
              ...
              // Language and Currency selection for all users
              const SizedBox(height: 16),
              ...
              Container(
                ...
                child: DropdownButtonHideUnderline(
                  child: DropdownButton<String>(
                    ...
                    icon: Icon(Icons.payments, color: context.textColor),
                    style: TextStyle(color: context.textColor),
                    dropdownColor: context.cardColor,
                    items: const [
                      ...
                      DropdownMenuItem(value: 'ZAR', child: Text('R ZAR — South African Rand')),
                    ],
                    onChanged: (String? value) {
                      if (value != null) {
