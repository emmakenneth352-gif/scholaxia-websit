...
import 'kind_homework_screen.dart';
...
class _KindShellState extends State<KindShell> {
  int _index = 0;
  final _homeworkKey = GlobalKey<KindHomeworkScreenState>();
    ...
    return ListenableBuilder(
      ...
      builder: (context, _) {
        final screens = [
          ...
          KindHomeworkScreen(key: _homeworkKey),
                ...
                children: List.generate(navItems.length, (i) {
                  ...
                  return Expanded(
                    child: GestureDetector(
                      onTap: () {
                        setState(() => _index = i);
                        if (i == 3) _homeworkKey.currentState?.load();
                      },
