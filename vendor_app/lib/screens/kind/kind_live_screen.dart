...
export '../../utils/live_join_helper.dart' show joinLiveDirectly;
                ...
                child: Column(
                  ...
                  children: [
                    KindHeroHeader(
                      greeting: 'Live Class',
                      subtitle:
                          'Join your teacher\'s lesson — booked for you with your parent\'s email.',
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text(
                                'Your teacher will start the class — tap Join when it\'s live.',
  ...
  Widget _liveCard(BuildContext context, Map<String, dynamic> c) {
    ...
    return Padding(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: () => joinLiveDirectly(context, _api, c),
          borderRadius: BorderRadius.circular(20),
          child: Ink(
            decoration: BoxDecoration(
